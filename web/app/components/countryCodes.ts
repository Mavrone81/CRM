// Full list of country calling codes (ISO dial codes) with flag + name.
// `code` is the numeric dial code used for phone normalization (default SG = 65).
export type CC = { code: string; name: string; flag: string };
...
export const COUNTRY_CODES: CC[] = [
  ...
  { code: '1', name: 'Dominican Rep.', flag: '🇩🇴' },
