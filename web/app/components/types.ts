...
export type WaNumber = { id: string; label: string; state: string; qr: string | null; sentToday?: number; cap?: number; dailyCap?: number };
export type Outreach = { running: boolean; queued: number; sent: number; failed: number };
